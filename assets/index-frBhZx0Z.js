...
`,s.onInput(e=>{let t=isNaN(Number(e))?0:Math.min(Math.max(Number(e),0),100);console.log(t),s.value=t.toString(),u.setValue(t)}),c.onClick(e=>{e?(u.setState(`animated`),l.setState(!1)):u.setState(`normal`)}),l.onClick(e=>{e?(u.setState(`hidden`),c.setState(!1)):u.setState(`normal`)});